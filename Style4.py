...
train = prepare_data(get_data('D:/s/Tensorflowspeechrecognition/train/train/audio/'))
shape = (129, 124, 1)
...
submission.to_csv('D:/s/Tensorflowspeechrecognition/submission.csv', index=False)