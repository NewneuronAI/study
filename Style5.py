...
train_df, valid_df = load_data('tsr/speech/')
...
from tensorflow.keras.layers import Input, Conv2D, MaxPooling2D, Activation, BatchNormalization, GlobalAveragePooling2D, GlobalMaxPool2D, concatenate, Dense, Dropout
...
test_paths = glob(os.path.join('D:/s/Tensorflowspeechrecognition/test/', 'test/audio/*wav'))
...
with open('D:/s/Tensorflowspeechrecognition/starter_submission.csv', 'w') as fout:
